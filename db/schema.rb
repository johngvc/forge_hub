...
ActiveRecord::Schema.define(version: 2021_03_08_234918) do
  ...
  create_table "chat_threads", force: :cascade do |t|
    ...
    t.bigint "project_receiver_id"
    t.boolean "is_user_chat", default: true
    t.boolean "is_project_chat", default: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "project_sender_id"
    t.integer "user_sender_id"
    t.index ["project_receiver_id"], name: "index_chat_threads_on_project_receiver_id"
  end
  ...
  add_foreign_key "chat_threads", "projects", column: "project_receiver_id"
